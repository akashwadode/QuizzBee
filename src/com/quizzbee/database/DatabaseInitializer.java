        ...
        try (Connection conn = DriverManager.getConnection(URL)) {
            if (conn != null) {
                ...
                if (rs.next() && rs.getInt(1) == 0) {
                    stmt.executeUpdate("INSERT INTO categories (category_name) VALUES " +
                            "('Maths'), ('Logical Reasoning'), ('English'), ('Computer Science'), ('AI')");

                    // Insert Maths questions
                    stmt.executeUpdate("INSERT INTO questions (category_id, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES " +
                    ...
                    // Insert Logical Reasoning questions
                    stmt.executeUpdate("INSERT INTO questions (category_id, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES " +
                    ...
                    // Insert Computer Science questions
                    stmt.executeUpdate("INSERT INTO questions (category_id, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES " +
